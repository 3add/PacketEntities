...
/**
 * Represents {@link EntityMetaFields.Avatar#PLAYER_MODE_CUSTOMISATION}
 */
public class AvatarPlayerModeCustomizationFlagsView extends BitmaskView {
    ...
    public AvatarPlayerModeCustomizationFlagsView(ProtocolEntityMeta store) {
        super(store, EntityMetaFields.Avatar.PLAYER_MODE_CUSTOMISATION);
    }
