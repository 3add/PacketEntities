...
/**
 * Represents {@link EntityMetaFields.AbstractHorse#FLAGS}
 */
public class AbstractHorseFlagsView extends BitmaskView {
    ...
    public AbstractHorseFlagsView(ProtocolEntityMeta store) {
        super(store, EntityMetaFields.AbstractHorse.FLAGS);
    }
