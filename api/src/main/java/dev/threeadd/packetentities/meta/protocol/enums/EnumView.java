...
/**
 * A {@link MetadataView} that represents a {@link ProtocolEnum},
 * 2 inherits implementing both serialization methods (varint and byte)
 *
 * @see ByteEnumView
 * @see VarIntEnumView
 */
public abstract class EnumView<E extends Enum<E> & ProtocolEnum, T extends Number> extends MetadataView<T> {
